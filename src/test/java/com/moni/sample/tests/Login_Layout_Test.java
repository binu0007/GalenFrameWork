...
public class Login_Layout_Test {
    ...
    public void Test02_Login_To_Application() {
        ...
        test.loginPage.login_to_the_application_as("admin", "manager");
	...
	/*
	 * @AfterClass public void stop_test_session() throws InterruptedException {
	 * Thread.sleep(5000); test.closeTestSession(); }
	 */
}
